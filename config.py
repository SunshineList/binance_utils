...
# 阈值
PERCENTAGE_DEFAULT = 3.6  # 中间值
TOP_PERCENTAGE_DEFAULT = 4.1 # 最大值
LOW_PERCENTAGE_DEFAULT = 3.1 # 最小值
PERCENTAGE_DIFF_DEFAULT = 0.5 # 差值 当在这个差值附近处理数据的时间会变成DYNAMIC_INTERVAL
